package com.algaworks.core.springfox.adapter;
...
public class TypeNameExtractorAdapter extends TypeNameExtractor {
    ...
    private String typeName(ModelNameContext context) {
        TypeNameProviderPlugin selected = (TypeNameProviderPlugin)this.typeNameProviders
                .getPluginOrDefaultFor(context.getDocumentationType(), new DefaultTypeNameProvider());
