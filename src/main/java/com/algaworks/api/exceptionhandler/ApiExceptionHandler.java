...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    public static final String MSG_ERRO_GENERICO_USUARIO_FINAL = "Ocorreu um erro inesperado no sistema." +
    ...
    private ResponseEntity<Object> handleInvalidFormat(InvalidFormatException ex, HttpHeaders headers, HttpStatus
    ...
    private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException ex, HttpHeaders headers,
        ...
        String path = joinPath(ex.getPath());
        ProblemType problemType = ProblemType.MENSAGEM_NAO_COMPREENSIVEL;
        String detail = String.format("A propriedade '%s' não existe. Corrija ou remova a propriedade e tente novamente",
                path);
    ...
    private ResponseEntity<Object> handleMethodArgumentTypeMismatch (
        ...
        String detail = String.format("O parâmetro URL '%s' recebeu o valor '%s' que é de um tipo inválido. " +
