...
import com.algaworks.api.openapi.controller.FormaPagamentoControllerOpenApi;
...
public class FormaPagamentoController implements FormaPagamentoControllerOpenApi {
    ...
    public ResponseEntity<CollectionModel<FormaPagamentoDTO>> listar(ServletWebRequest request){
        ...
        CollectionModel<FormaPagamentoDTO> formasPagamentoDTO = formaPagamentoDTOAssembler.toCollectionModel(formasPagamentos);
    ...
    public FormaPagamentoDTO alterar(@PathVariable Long id, @RequestBody @Valid FormaPagamentoInput formaPagamentoInput){
        ...
        return this.formaPagamentoDTOAssembler.toModel(formaPagamento);
    }
